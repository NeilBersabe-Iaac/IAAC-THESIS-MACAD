...
const model = '../aggre_test/script.js'
...
//   Object3D.getWorldDirection (0,0,0)
  ...
  const domelight = new THREE.HemisphereLight(0xffffff, 0x000000, 4);
  scene.add(domelight);
...
//   geoMaterial = new THREE.MeshStandardMaterial({ color: "white" });
  raycaster = new THREE.Raycaster();

  const loader = new Rhino3dmLoader();
  loader.setLibraryPath("https://cdn.jsdelivr.net/npm/rhino3dm@0.13.0/");

  loader.load("../assets/aggre_test.3dm", function (object) {
